...
export async function createUser(user: CreateUserParams) {
  try {
    ...
    const newUser = await User.create(user); //wait and create in doc. from frontend. string to user id
...
// UPDATE -- find user in db and update if not find throw user update failed
